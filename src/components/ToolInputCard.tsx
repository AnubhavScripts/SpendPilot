      ...
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <div>
          ...
          {errors.tools?.[index]?.tool?.message && (
            <p className="mt-1 text-[10px] text-rose-400">{errors.tools?.[index]?.tool?.message as string}</p>
          )}
        </div>
        ...
        <div>
          ...
          {errors.tools?.[index]?.plan?.message && (
            <p className="mt-1 text-[10px] text-rose-400">{errors.tools?.[index]?.plan?.message as string}</p>
          )}
        </div>
        ...
        <div>
          ...
          {errors.tools?.[index]?.monthlySpend?.message && (
            <p className="mt-1 text-[10px] text-rose-400">{errors.tools?.[index]?.monthlySpend?.message as string}</p>
          )}
        </div>
        ...
        <div>
          ...
          {errors.tools?.[index]?.seats?.message && (
            <p className="mt-1 text-[10px] text-rose-400">{errors.tools?.[index]?.seats?.message as string}</p>
          )}
        </div>
      </div>
    </motion.div>
